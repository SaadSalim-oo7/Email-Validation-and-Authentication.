  ...
  const { signup, error, isLoading } = useUserStore();
   ...
   return (
    <motion.div 
       ...
       className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-x1
       overflow-hidden'
    >
      <div className='p-8'>
      ...
      <div className='pa-8 py-4 bg-gray-900 bgg-opacity-50 flex justify-center'>
